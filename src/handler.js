...
const getAllBooksHandler = (request,h) => {
    ...
    if(name !== undefined){
        filteredBooks = filteredBooks.filter((book) => books.name.toLowerCase().includes(name.toLowerCase()));
    }
    if (reading !== undefined) {
        filteredBooks = filteredBooks.filter((book) => books.reading === true);
    }
    
    if (finished !== undefined) {
        filteredBooks = filteredBooks.filter((book) => books.finished === (finished === '1'));
    }
